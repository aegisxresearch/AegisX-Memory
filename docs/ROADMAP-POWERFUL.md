...
| ~~1.6~~ | ✅ **`uninstall --agent <name>`** — cabut entri MCP + blok aturan + hook, dengan backup; mirror installer (repo AGENTS.md & hook project ikut dicabut) | sekarang §17 hanya instruksi manual; memasang lebih mudah daripada melepas | M | tes: file kembali seperti semula (17 tes uninstall) — mendarat |
